...
class RDN(nn.Module):
    def __init__(self, scale_factor, blurpool, num_channels, num_features, growth_rate, num_blocks, num_layers):
        ...
        self.sfe1 = nn.Conv2d(num_channels, num_features, kernel_size=(3, 3), padding=3 // 2)
        self.sfe2 = nn.Conv2d(num_features, num_features, kernel_size=(3, 3), padding=3 // 2)
        ...
        self.output = nn.Conv2d(self.G0, num_channels, kernel_size=(3, 3), padding=3 // 2)
